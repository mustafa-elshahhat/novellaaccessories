...
public sealed record CartItemDto(
    ...
    string ProductNameAr, string ProductNameEn, string ProductSlugAr, string ProductSlugEn,
    string? PrimaryImageUrl, string? PrimaryImageAltAr, string? PrimaryImageAltEn,
    string? VariantNameAr, string? VariantNameEn, string Sku,
