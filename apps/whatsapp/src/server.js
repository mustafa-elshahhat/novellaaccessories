...
import { SendRateLimiter } from './services/rateLimiter.service.js';
...
const circuitBreaker = new CircuitBreaker(config.circuitBreakerThreshold, config.circuitBreakerCooldownMs);
